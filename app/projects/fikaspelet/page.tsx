            ...
            <ProjectSection title="What we built">
                ...
                <ProjectMockupGrid
                    mockups={[
                        {
                            src: mockup1,
                            alt: 'Start screen showing the FikaSpelet logo, a skiing Lussebulle, email input and a Starta button.',
                            caption: 'Start',
                        },
                        {
                            src: mockup2,
                            alt: 'Game screen showing the skiing character dodging obstacles and collecting lussebullar.',
                            caption: 'Game',
                        },
                        {
                            src: mockup3,
                            alt: "Game over screen showing the player's score and a leaderboard preview.",
                            caption: 'Game over',
                        },
                        {
                            src: mockup4,
                            alt: 'Discount code modal with a golden Lussebulle and a button to copy the code and visit Svensk Husman.',
                            caption: 'Golden Lussebulle (discount code)',
                        },
                    ]}
                    cols={5}
                    aspectRatio="9/19"
                    ...
                    stats={[
                        {
                            value: '2,500',
                            label: 'Play sessions',
                            subtitle: 'Over a two day test period',
                        },
                        {
                            value: '40x',
                            label: 'Plays per person',
                            subtitle: 'Average across all users',
                        },
                        {
                            value: '126',
                            label: 'Redirects to svenskhusman.se',
                            subtitle: 'Via discount code and game over CTA',
                        },
                    ]}
                />
            </ProjectSection>
