    ...
    return (
        <article className="flex flex-col gap-4 md:gap-8 min-h-screen pt-24 md:pt-32">
            ...
            <ProjectHeader
                ...
                tags={["Mobile Development", "React Native", "Node.js", "Socket.io", "Design Sprint", "Prototyping", "Figma"]}
                meta={[
            ...
            <ProjectSection title="What we built">
                ...
                <div className="flex flex-row gap-4 md:gap-6 lg:gap-8 justify-center">
                    <div className="w-1/3">
                        <ProjectImage src={iphoneStart} alt="iOS home screen showing the Sketch'N'Guess logo with Join, Create and Rules buttons." />
                    </div>
                    <div className="w-1/3">
                        <ProjectImage src={androidStart} alt="Android home screen showing the Sketch'N'Guess logo with Join, Create and Rules buttons." />
                    </div>
                </div>
                ...
                <ProjectMockupGrid
                    mockups={[
                        { src: iphoneCreate, alt: "iOS create screen showing a map with a canvas boundary and canvas size options.", caption: "iOS — Create: Setup of canvas" },
                        { src: iphoneCreate2, alt: "iOS create screen showing a map preview, canvas size set to 50x50, duration set to 3 minutes, rounds set to 5, nickname field filled with Oak, plus Back and Create buttons.", caption: "iOS — Create: Setup of game settings" },
                        { src: iphoneLobby, alt: "iOS lobby screen showing room code Q28605, a leaderboard in round 1 of 5 with player OAK on 0 points, and Leave and Start buttons.", caption: "iOS — Created lobby" },
                        { src: androidJoin, alt: "Android join screen showing an empty form with fields for Lobby Code and Nickname, plus Back and Join buttons.", caption: "Android — Join popup" },
                        { src: androidJoin2, alt: "Android join screen showing the join form filled in with lobby code Q286O5 and nickname Oak2.", caption: "Android — Entered information" },
                    ]}
                    cols={5}
                    aspectRatio="9/19"
                />
                ...
                <ProjectMockupGrid
                    mockups={[
                        { src: iphoneLobby2, alt: "iOS lobby screen showing room code Q28605, a leaderboard in round 1 of 5 with players OAK and OAK2 both on 0 points, and Leave and Start buttons.", caption: "iOS — Lobby" },
                        { src: androidLobby, alt: "Android lobby screen showing room code Q28605, a leaderboard in round 1 of 5 with players OAK and OAK2 both on 0 points, and a Leave button.", caption: "Android — Lobby" },
                        { src: iphoneGamestart, alt: "iOS lobby screen showing the countdown overlay with the number 4, room code Q28605, and players OAK and OAK2 both on 0 points.", caption: "iOS — Countdown before round" },
                        { src: androidGamestart, alt: "Android lobby screen showing the countdown overlay with the number 4 before the round starts.", caption: "Android — Countdown before round" },
                    ]}
                    cols={4}
                    aspectRatio="9/19"
                />
                ...
                <ProjectMockupGrid
                    mockups={[
                        { src: androidDraw, alt: "Android draw screen showing the word BOX, an empty map canvas, drawing tools for brush size, stroke style, undo, and color, plus a To Lobby button.", caption: "Android — Drawing in progress" },
                        { src: androidDraw2, alt: "Android draw screen showing the word BOX with a slightly larger brush size selected on the drawing tools panel.", caption: "Android — Drawing further along" },
                        { src: iphoneGuess, alt: "iOS guess screen showing a partial GPS-traced shape on the map canvas, a text input for guesses, a Guess button, and a To Lobby button.", caption: "iOS — Watching the drawing appear" },
                        { src: iphoneGuess2, alt: "iOS guess screen showing a near-complete GPS-traced box shape on the map canvas, a text input for guesses, a Guess button, and a To Lobby button.", caption: "iOS — Guessing" },
                    ]}
                    cols={4}
                    aspectRatio="9/19"
                />
                ...
                <ProjectMockupGrid
                    mockups={[
                        { src: iphoneChat, alt: "iOS draw screen showing the word BOX, a chat message from OAK2 reading HOUSE on the map canvas, drawing tools for brush size, stroke style, undo, and color, plus a To Lobby button.", caption: "iOS — Chat with guesses" },
                        { src: androidChat, alt: "Android guess screen showing the map canvas, a chat message from OAK2 reading HOUSE, a text input for guesses, a Guess button, and a To Lobby button.", caption: "Android — Chat with guesses" },
                        { src: iphoneCorrect, alt: "iOS guess screen showing the correct guess overlay with the message: OAK guessed the correct word! It was BOX, with the guess input and buttons faded in the background.", caption: "iOS — Correct guess" },
                        { src: androidCorrect, alt: "Android draw screen showing the correct guess overlay with the message: OAK guessed the correct word! It was BOX.", caption: "Android — Correct guess" },
                        { src: iphoneLeaderboard, alt: "iOS lobby screen showing room code Q28605, a leaderboard in round 2 of 5 with OAK on 10 points and OAK2 on 5 points, and Leave and Start buttons.", caption: "iOS — Updated leaderboard" },
                        { src: androidLeaderboard, alt: "Android lobby screen showing room code Q28605, a leaderboard in round 2 of 5 with OAK on 10 points and OAK2 on 5 points, and a Leave button.", caption: "Android — Updated leaderboard" },
                    ]}
                    cols={6}
                    aspectRatio="9/19"
                />
