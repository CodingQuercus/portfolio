            ...
            <ProjectSection title="Process">
                ...
                <ProjectProcessList
                    steps={[
                        ...
                        { title: "Prototype: LoFi → HiFi in Figma", information: "Two prototype iterations were created in Figma. The LoFi test surfaced issues with response length, visual noise, and unclear document connections, which directly shaped the HiFi design. AI responses were simulated rather than live, keeping the focus on interface design and trust mechanics." },
