    ...
    return (
        <article className="flex flex-col gap-4 md:gap-8 min-h-screen pt-24 md:pt-28">
            ...
            <ProjectSection title="Process">
                <ProjectImage
                    src={methodImage}
                    alt="The design thinking process and its five phases empathize, define, ideate, prototype and test."
                />
                <ProjectProcessList
                    steps={[
                        {
                            title: 'Empathize: Interviews',
                            information:
                        ...
                        {
                            title: 'Define: Thematic Analysis & User Need Statements',
                            information:
                        ...
                        {
                            title: 'Prototype: LoFi → HiFi in Figma',
                            information:
                        ...
                        {
                            title: 'Test: Two rounds of moderated usability testing',
                            information:
            ...
            <ProjectSection title="Prototype">
                <ProjectMockupGrid
                    mockups={[
                        {
                            src: mockup1,
                            alt: 'The start view of the HiFi prototype, showing a conversational search interface with role-based suggested questions and a search input field.',
                            caption:
                                'Start view with role-based suggested questions and a search input',
                        },
                        {
                            src: mockup2,
                            alt: 'A conversation view showing the system asking for more context, a generated response with a source card containing document metadata, and a related document suggestion.',
                            caption:
                                'Generated response with source card and related document',
                        },
                        {
                            src: mockup3,
                            alt: 'The original document view of a routine, showing document metadata including creator, approver, and dates, alongside the full document content.',
                            caption:
                                'Original document view with full metadata',
                        },
                        {
                            src: mockup4,
                            alt: 'The summary view of a document, showing collapsible sections for each part of the routine.',
                            caption:
                                'Summary view with collapsible sections for quick navigation',
                        },
                        {
                            src: mockup5,
                            alt: 'A flowchart view of an assembly instruction, showing an information node, a step node, and a control point node connected by arrows.',
                            caption:
                                'Flowchart view of an assembly instruction',
                        },
                        {
                            src: mockup6,
                            alt: 'A presentation view of an assembly instruction, showing a step progress bar at the top and the current step content below.',
                            caption:
                ...
                <div className="flex flex-col gap-4">
                    <ProjectStatRow
                        stats={[
                            {
                                value: '90',
                                label: 'SUS Score — System Usability Scale',
                                subtitle: 'Grade A • Excellent Usability',
                            },
                            {
                                value: '5.50',
                                label: 'Trust Score — S-TIAS',
                                subtitle:
