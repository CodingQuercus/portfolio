    ...
    return (
        <article className="flex flex-col gap-4 md:gap-6 min-h-screen pt-24 md:pt-28">
            ...
            <ProjectSection title="Concept Evolution">
                ...
                <ProjectImage
                    src={moscowImage}
                    alt="MoSCoW produced after the joint concept session with ECU students."
                />
            </ProjectSection>
            ...
            <ProjectSection title="Design">
                ...
                <ProjectMockupGrid
                    ...
                    mockups={[
                        {
                            src: mockup1,
                            alt: 'Onboarding screen showing the aWAre splash and login flow.',
                            caption: 'Onboarding',
                        },
                        {
                            src: mockup2,
                            alt: 'Map view showing hazard pins across Western Australia.',
                            caption: 'Map with hazard pins',
                        },
                        {
                            src: mockup3,
                            alt: 'Community feed showing location-based posts from other travellers.',
                            caption: 'Community feed',
                        },
                        {
                            src: mockup4,
                            alt: 'Warnings list showing colour-coded hazard severity.',
                            caption: 'Warnings list',
                        },
                    ]}
                />
            </ProjectSection>
            ...
            <ProjectSection title="Pin Clustering">
                ...
                <ProjectMockupGrid
                    ...
                    mockups={[
                        {
                            src: clusterBefore,
                            alt: 'Overlapping pins before clustering.',
                            caption: 'Before clustering',
                        },
                        {
                            src: clusterOne,
                            alt: 'All pins clustered into one.',
                            caption: 'Widest zoom',
                        },
                        {
                            src: clusterThree,
                            alt: 'Cluster dissolving into pins.',
                            caption: 'Zooming in',
                        },
                        {
                            src: clusterFour,
                            alt: 'Individual pins at closer zoom.',
                            caption: 'Closer zoom',
                        },
                    ]}
                />
                <ProjectCodeBlock
                    code={clusterCode}
                    description="groupPins algorithm implemented with TypeScript"
                />
                <ProjectParagraph
                    paragraphs={[
