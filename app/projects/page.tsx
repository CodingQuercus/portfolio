...
export const metadata: Metadata = {
    title: 'Projects',
    description: 'A mix of academic work and things I keep building on my own time.',
}
...
const projects = [
    {
        ...
        description: 'A full-stack job application tracker built to solve a real problem during my own job search.',
        href: '/projects/maj',
    },
    {
        title: "M.Sc. Thesis",
...
export default function ProjectsPage() {
    return (
        <section className="flex flex-col pt-24 md:pt-30">
            <div className="flex flex-col gap-4">
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold">Projects</h1>
            </div>

            <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                {projects.map((project, index) => (
                    <ProjectCardMini {...project} key={project.title + "_" + index}/>
                ))}
            </ul>
        </section>
    )
