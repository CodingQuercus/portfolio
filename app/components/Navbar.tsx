...
export default function Navbar() {
    ...
    return (
        <>
            <nav
                className="fixed z-50 top-0 inset-x-0 bg-background shadow-md"
                            ...
                            {[
                                ...
                                return (
                                    <Link
                                        ...
                                        className={`text-lg text-center px-4 py-2 rounded-full transition-colors ${
                                            isActive
