...
export default function Header({ currentSection, menuIsActive, toggleMenu, navigateToSection }) {
    ...
    return (
        <div className="w-full flex flex-row bg-[#282828] justify-between items-center sticky top-0 py-4 z-30 px-10 md:px-16 xl:px-48 2xl:px-72 shadow-md transition-colors duration-300">
            <motion.button
