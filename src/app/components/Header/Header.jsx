...
export default function Header({ currentSection, menuIsActive, toggleMenu, navigateToSection }) {
    ...
    return (
        <div className={`w-full flex flex-row justify-between items-center sticky top-0 py-4 z-30 px-10 md:px-16 lg:px-48 xl:px-72 shadow-md transition-colors duration-300 ${currentSection === 'home' ? 'bg-transparent' : 'bg-[#282828]'
            }`}>
            <motion.button
                onClick={() => navigateToSection("home")}
                whileHover={{ scale: 1.05 }}
                className="flex items-center justify-center gap-2 text-[#282828] bg-[#f3f3f3] rounded-lg w-12 h-12 md:h-16 md:w-16 cursor-pointer hover:bg-[#282828] hover:text-[#f3f3f3] hover:border-[#f3f3f3] hover:border-2 transition-colors"
            >
            ...
            <motion.button
                ...
                className="flex items-center justify-center gap-2 text-[#282828] bg-[#f3f3f3] rounded-lg w-12 h-12 md:h-16 md:w-16 cursor-pointer hover:bg-[#282828] hover:text-[#f3f3f3] hover:border-[#f3f3f3] hover:border-2"
                whileHover={{ scale: 1.05 }}
